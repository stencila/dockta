...
RUN apt-add-repository "deb https://mran.microsoft.com/snapshot/2017-01-01/bin/linux/ubuntu focal-cran40/"
...
test('generate:r-xml2', async () => {
  ...
  expect(dockerfile).toEqual(`FROM ubuntu:20.04
...
RUN apt-key adv --keyserver keyserver.ubuntu.com --recv-keys 51716619E084DAB9
RUN apt-add-repository "deb https://mran.microsoft.com/snapshot/${pkg.datePublished}/bin/linux/ubuntu focal-cran40/"
